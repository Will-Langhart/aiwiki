-- Add popularity_score column to tools
ALTER TABLE public.tools
  ADD COLUMN IF NOT EXISTS popularity_score integer NOT NULL DEFAULT 0;

CREATE INDEX IF NOT EXISTS tools_popularity_score_idx ON public.tools (popularity_score DESC);

-- Update search_tools function to use popularity_score when no query
