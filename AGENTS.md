...
> This file primes you (Codex) on how to work effectively in this repo. Read `SPEC.md` first for the full product and architecture. This file is the **operating manual** — how to make changes, what conventions to follow, and where to look for what.
